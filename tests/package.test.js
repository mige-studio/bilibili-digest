...
test('安装声明只覆盖 B 站当前视频、音轨与两类可选服务',()=>{
  ...
  assert.deepEqual(m.optional_host_permissions,['https://ark.cn-beijing.volces.com/*','https://*.bilivideo.com/*','https://*.bilivideo.cn/*','https://openspeech.bytedance.com/*']);assert.equal(m.background.type,'module');
